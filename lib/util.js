...
Log.prototype.write = function(message, type, data){
...
Log.prototype.success = function(message, data){
  this.write(message, this.LOGTYPE.SUCCESS, data);
};

Log.prototype.warn = function(message, data){
  this.write(message, this.LOGTYPE.WARN, data);
};

Util.prototype.log = new Log();